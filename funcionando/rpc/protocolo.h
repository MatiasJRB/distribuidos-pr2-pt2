...
#define REPORT_UPDATE 4
extern  int * report_update_1(Mensaje *, CLIENT *);
extern  int * report_update_1_svc(Mensaje *, struct svc_req *);
...
extern  int * is_file_1_svc(Mensaje *, struct svc_req *);
...
#define REPORT_UPDATE 4
extern  int * report_update_1();
extern  int * report_update_1_svc();
#define REPORT_CREATE 5
...
#define IS_FILE 8
extern  int * is_file_1();
extern  int * is_file_1_svc();
#define REPORT_UPDATE_DIRECTORY 9
